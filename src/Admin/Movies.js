    ...
    <div id="grid">
      ...
      <div className="series-details">
        <div className="series-box">
          ...
          />
          <p>
            <strong>Casts:</strong> <span id="series-cast">{series.cast}</span>
          </p>
          <div className="youtube_link">
            <iframe
              width="508"
          ...
          <p>
            <strong>Genre:</strong>
            <span id="series-genre">{series.genre}</span>
          </p>
          <p>
            <strong>Category:</strong>
            <span id="series-category">{series.category}</span>
          </p>
          <p>
            <strong>Origin/Country:</strong>
            <span id="series-country">{series.country}</span>
          </p>
          <p>
            <strong>Total Episodes:</strong>
            <span id="series-episodes">{series.episodes}</span>
          </p>
          <p>
            <strong>Language:</strong>
            <span id="series-language">{series.language}</span>
          </p>
          <p>
            <strong>Updated:</strong>
            <span id="series-updated"> {timeSince(series.postDate)}</span>
          </p>
          <p>
            <strong>Release:</strong>
            <span id="series-release">{timeSince(series.releaseDate)}</span>
          </p>
          <h3>Episodes:</h3>
          <ul id="episodes-list">
            {episodesList
              .filter((episode) => episode.seriesTitle === series.title)
              .map((episode) => (
                <li key={episode._id}>
                  {episode.season} {episode.episode}
                  <div className="light_btn">
                    <Link to={episode.downloadLink}>
                      <span></span>
                      <span></span>
                      <span></span>
                      <span></span>
